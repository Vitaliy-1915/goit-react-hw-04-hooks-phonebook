...
import useLocalStorage from "../../LocalStorageHooks/LocalStorageHooks";
import { PhoneBookCard } from "./PhoneBookCards.styles";
import { v4 as unId } from "uuid";

export default function PhoneBookCards() {
...
// export default class OldPhoneBookCards extends Component {
// state = {
//   contacts: [
